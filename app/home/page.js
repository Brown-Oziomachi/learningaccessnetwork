    ...
    return (
        <div className="min-h-screen bg-neutral-100">
            ...
            {displayBooks.length === 0 ? (
                ...
                <>
                    ...
                    <div className="px-4 py-8 lg:px-0 mx-auto max-w-7xl">
                        ...
                        <div className="relative">
                            ...
                            <div className="hidden lg:block relative -mx-4 lg:mx-0">
                ...
                `}</style>
                                    <div className="flex gap-5 lg:gap-20 pb-2">
                                        {displayBooks.slice(0, 5).map((book) => (
                                            <Link
                                                key={book.id}
                                                href={`/book/preview?id=${book.id}`}
                                                className="flex-none w-[220px] group"
                                            >
                                                <div className="relative mb-3">
                                                    <img
                                                        src={book.image}
                                                        alt={book.title}
                                                        className="w-full h-[320px] object-cover rounded shadow-md group-hover:shadow-xl transition-shadow"
                                                        onError={(e) => { e.target.src = 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400'; }}
                                                    />
                                                    {isPurchased(book.id) && (
                                                        <span className="absolute top-2 right-2 bg-green-600 text-white px-2 py-1 rounded text-xs font-bold">Owned</span>
                                ...
                                {displayBooks.length > 4 && (
                                    <button className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 w-11 h-11 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors z-10 border border-gray-200">
                                    </button>
                                )}
                            </div>
                        </div>
