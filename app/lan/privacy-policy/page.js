...
export default function PrivacyPolicy() {
  return (
    <div className="prose prose-lg max-w-none lg:p-20 p-6">
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-700 leading-relaxed mb-4">
          Welcome to LAN Library. We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our local area network library management system.
        </p>
      ...
      <section className="mb-10">
        ...
        <h4 className="text-xl font-semibold text-slate-700 mb-3 mt-6">2.3 Device and Network Information</h4>
        <p className="text-slate-700 leading-relaxed mb-4">
          We automatically collect certain information about your device and network connection, including IP address, device type and model, operating system, browser type and version, unique device identifiers, network connection type, and local network information. This data helps us optimize performance and security.
        </p>
      ...
      <section className="mb-10">
        <h3 className="text-2xl font-semibold text-slate-800 mb-4">9. International Data Transfers</h3>
        <p className="text-slate-700 leading-relaxed">
          As LAN Library operates primarily within local area networks, data typically remains within your organization's network infrastructure. However, certain service components, such as cloud backups or analytics services, may involve data transfers to servers located in different countries. When such transfers occur, we ensure appropriate safeguards are in place to protect your information in accordance with this Privacy Policy and applicable law.
        </p>
      </section>
