    ...
    return (
        <AuthLayout backPath="/auth/signin">
            ...
            <button
                ...
                className="max-md:w-full lg:w-1/4 mx-auto bg-blue-950 text-white py-3 rounded-full font-semibold hover:bg-blue-900 transition-colors mb-auto disabled:opacity-50 disabled:cursor-not-allowed"
            >
