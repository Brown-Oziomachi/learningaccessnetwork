...
export const validateEmail = async (email) => {
    ...
    // ✅ REPLACED: Accept Gmail + academic/institutional emails
    ...
    const ACADEMIC_PATTERNS = [
        /\.edu$/,
        /\.edu\.[a-z]{2}$/,       // .edu.ng, .edu.gh, .edu.za, .edu.ug etc
        /\.ac\.[a-z]{2}$/,        // .ac.uk, .ac.za, .ac.ng etc
        /\.ac\.ng$/,
    ];
    ...
    if (!isGmail && !isAcademic) {
        errors.email = 'Please use a Gmail address or a valid university email (e.g. name@unilag.edu.ng, prof@university.ac.uk)';
        return { isValid: false, errors };
    }
