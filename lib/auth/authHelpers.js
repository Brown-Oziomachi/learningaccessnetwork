    ...
    try {
        ...
        const userProfile = {
            ...
            ...(rawRole === 'lecturer' ? {
                ...
                verificationStatus: 'pending',      // ← admin sees this
                ...
                staffIdUrl: formData.staffIdUrl || null,           // ← NEW
                appointmentLetterUrl: formData.appointmentLetterUrl || null,  // ← NEW
                facultyProfileUrl: formData.facultyProfileUrl || null,        // ← NEW
                title: formData.lecturerTitle || null,             // ← also saves to title field for badge logic
            } : {}),
        };
