...
export async function createUserAccount(formData) {
    try {
        ...
        const userProfile = {
            ...
            // Inside the userProfile object, add these fields to the lecturer spread:
            ...(isLecturerRole ? {
                isLecturer: false,          // blocked until approved
                isSeller: false,            // blocked until approved
                ...
                title: formData.lecturerTitle || null,
                selectedUniversity: formData.selectedUniversity || null,
                institution: formData.institution || null,
                staffIdUrl: formData.staffIdUrl || null,
                appointmentLetterUrl: formData.appointmentLetterUrl || null,
                facultyProfileUrl: formData.facultyProfileUrl || null,
                submittedForVerification: serverTimestamp(),
            } : {}),
        };

        // Send notification to sellers and lecturers only
