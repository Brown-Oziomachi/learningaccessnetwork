...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://lanlibrary.com";
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding:22px 40px">
                    ...
                    <p style="font-size:9px;letter-spacing:0.22em;text-transform:uppercase;color:rgba(255,255,255,0.35);margin:4px 0 0;font-family:'Lato',sans-serif">Africa's Academic Document Exchange</p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="center">
                    ...
                    <p style="margin:0;font-size:10px;color:rgba(255,255,255,0.2);line-height:1.7;font-family:'Lato',sans-serif">
                      LAN Library Ltd &nbsp;·&nbsp; Lagos &amp; Abuja, Nigeria<br/>
...
/* ─────────────────────────────────────────────────────────────────
   5. PAYOUT SUCCESS
───────────────────────────────────────────────────────────────── */
function buildPayoutSuccess({ name, amount, bankName, accountName, withdrawalId }) {
...
function buildOrderReceipt({ name, bookTitle, amount, sellerName, orderId }) {
    ...
    ${contentOpen()}
      ...
      ${para(`This is your official receipt. Keep this email for your records. For support, <a href="mailto:help@lanlibrary.com" style="color:${GOLD}">contact help@lanlibrary.com</a>.`)}
    ${contentClose}
...
function buildAbandonedCart({ name, cartItems = [] }) {
    ...
    ${contentOpen()}
      ...
      ${para(`You have items in your LAN Library cart. Complete your purchase and get instant access to your documents.`)}
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
          <td style="padding:16px 20px">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              ${itemRows}
              ${cartItems.length >= 3 ? `<tr><td style="padding:10px 0"><p style="font-size:12px;color:#9ca3af;margin:0;font-style:italic;font-family:'Lato',sans-serif">+ more items in your cart…</p></td></tr>` : ""}
            </table>
          </td>
        </tr>
      </table>
    ${contentClose}
    ${btn("Complete My Purchase", `${BASE_URL}/cart`, GOLD, WHITE)}
    <tr><td style="height:32px"></td></tr>`;

    return base({ preheader: `${name}, you left ${cartItems.length} item(s) in your LAN Library cart.`, body });
}
...
function buildAdBoost({ name, tier, durationDays, amount }) {
    ...
    ${contentClose}
    ${btn("View Ad Performance", `${BASE_URL}/upload-document/seller-account`, GOLD, WHITE)}
    <tr><td style="height:32px"></td></tr>`;
