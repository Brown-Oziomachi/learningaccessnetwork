...
const getNotificationIcon = (type) => {
  switch (type) {
    ...
    case "referral_reward":
      return (
        <Gift size={18} className="text-purple-500 flex-shrink-0 mt-0.5" />
      );
    case "sale":
      return (
        <DollarSign size={18} className="text-blue-500 flex-shrink-0 mt-0.5" />
      );
    case "new_upload":
      return (
...
export default function NotificationBell({ userId }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute right-0 top-12 w-[calc(100vw-2rem)] sm:w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 z-[999] overflow-hidden fixed left-4 right-4 sm:absolute sm:left-auto sm:right-0">
