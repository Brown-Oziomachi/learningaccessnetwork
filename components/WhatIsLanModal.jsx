...
export default function WhatIsLanModal({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed right-0 top-0 h-full w-full md:w-[600px] bg-white shadow-2xl z-[999] overflow-y-auto animate-slideInRight">
        ...
        <div className="p-6 space-y-6 text-gray-700 leading-relaxed">
          ...
          <p className="text-base">
            ...
            opportunity, and where both creators and learners benefit from the
          ...
          <div className="space-y-4 border-t border-gray-200 pt-6">
            ...
            <p>
              We also believe that creators deserve to be compensated for their
